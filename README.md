# 🚀 안녕하세요, 기술로 가치를 만드는 개발자 입니다!

> **오랜 경험을 바탕으로 레거시 현대화부터 기술적 해결책을 통해 비즈니스 문제를 해결합니다.**
> 보훈병원 ABC 시스템 구축 프로젝트를 성공적으로 이끌어 **계약직에서 정규직 채용까지**되었으며, 현재 차세대 EMR의 안정적인 안착에 일조 했습니다.

## 🛠 Tech Stack

**Languages & Frameworks**
- ![C#](https://img.shields.io/badge/c%23-%23239120.svg?style=for-the-badge&logo=c-sharp&logoColor=white) ![.NET](https://img.shields.io/badge/.NET-512BD4?style=for-the-badge&logo=.net&logoColor=white) (MVC, WebForms, WinForms, Entity Framework)
- ![Java](https://img.shields.io/badge/java-%23ED8B00.svg?style=for-the-badge&logo=openjdk&logoColor=white) ![Spring Boot](https://img.shields.io/badge/Spring%20Boot-6DB33F?style=for-the-badge&logo=spring-boot&logoColor=white) (JPA, Hibernate, Thymeleaf)
- ![JavaScript](https://img.shields.io/badge/javascript-%23323330.svg?style=for-the-badge&logo=javascript&logoColor=%23F7DF1E) (VanillaJS, jQuery, Hybrid App/Cordova)
- ![Classic ASP](https://img.shields.io/badge/ASP-blue?style=for-the-badge) (vba, Legacy Modernization 전문가)
...
**Tools & DevOps**
- ![Git](https://img.shields.io/badge/git-%23F05033.svg?style=for-the-badge&logo=git&logoColor=white) ![Azure DevOps](https://img.shields.io/badge/Azure%20DevOps-0078D7?style=for-the-badge&logo=azure-devops&logoColor=white) ![SVN](https://img.shields.io/badge/SVN-809CC9?style=for-the-badge&logo=subversion&logoColor=white) ![Docker](https://img.shields.io/badge/docker-%230db7ed.svg?style=for-the-badge&logo=docker&logoColor=white)

---

### 🏥 Recent Experience (보훈병원, 2023.10 ~ 현재)

**차세대 EMR & 의료 경영 정보 시스템 고도화**
- **보험청구 및 심사 파트**: 차세대EMR 보험청구/심사 파트 전산 담당
- **ABC(Activity-Based Costing) 시스템 구축**: 의료 데이터 기반 활동기준 원가계산 시스템 도입 (전국 6개 보훈병원 통합 경영 체계 구축 기여)
  - [관련 뉴스 보기](https://n.news.naver.com/article/003/0012497747?sid=102)

---

### 🚘 Core Career Highlights (㈜오토브레인, 2011.06 ~ 2023.09)

**팀장 / 부장으로서 기술 전략 수립 및 대규모 프로젝트 리드**
- **기술 스택 전환 리드**: Classic ASP → ASP.NET MVC(C#), Java Struts → Spring Boot 로의 전사적 아키텍처 현대화 주도
- **수입차 M사 공식 딜러 및 임포터 주요 시스템 개발**: 
  - **KIOSK / Service**: CRM API 연동 및 서명/동의서 PDF 생성 시스템 구축
  - **SRS(Spring Boot)**: 본인인증 및 대외 기관 API 연동 기반 시스템 구축
- **하이브리드 앱 개발**: Cordova/Phonegap 기반의 다수 브랜드(P사, C사, 태권도 세계 선수권 등) 홍보 및 정보 서비스 출시

---

### 📡 Network Management System (조은정보기술㈜, 2008 ~ 2010)

**공공기관 NMS 인프라 구축**
- **한국은행, 행정안전부, 서울지방경찰청**: SNMP, TCP/IP, ICMP 프로토콜 기반의 네트워크 관리 시스템 UI 및 코어 개발 (DevExpress, WCF 활용)
...
|------------|-----------------------|---------|---------|----|----|----------|------|--------------------|------|
| 타이틀리스트 수주회 | 23.06~23.08 | 타이틀리스트 | <img src="https://via.placeholder.com/120x1/00000000/00000000" /><br/>오토브레인 | PG | Windows | asp.net mvc(c#), entity frameworkf, vanillaJs(javascript) | mariadb | visual studio, svn, devops
...
- **Email**: [![Gmail Badge](https://img.shields.io/badge/Gmail-d14836?style=for-the-badge&logo=Gmail&logoColor=white)](mailto:kimyaig@gmail.com)
